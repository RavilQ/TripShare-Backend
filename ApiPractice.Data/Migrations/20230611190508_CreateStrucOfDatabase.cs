...
{
    public partial class CreateStrucOfDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarImage = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CarNumer = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    SelfPhoto = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Smooking = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupLocationsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripPickups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripPickups_PickupLocations_PickupLocationsId",
                        column: x => x.PickupLocationsId,
                        principalTable: "PickupLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripPickups_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripPickups_PickupLocationsId",
                table: "TripPickups",
                column: "PickupLocationsId");

            migrationBuilder.CreateIndex(
                name: "IX_TripPickups_TripId",
                table: "TripPickups",
                column: "TripId");
